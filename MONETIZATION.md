...
Generated on 2026-07-18, last updated 2026-08-15(二)
...
>
> **2026-08-15 晚间更新**：应产品要求按传统命书框架重构付费章节,9 章→8 章——命盘/日元/五行/格局倾向/事业与财富/婚姻感情/学习成长/身体健康。原 v1 叙事三章拆并进命盘(主线结构)、事业与财富(系统模式+晚运)、婚姻感情(六亲)、学习成长(天赋+高低配);格局章按「格局倾向」模糊叙事红线执行(禁硬分类)。`bazi_deep_paid` prompt_version 4→5。免费 2 章(性格底色+事业方向)不变;v1 链 M0-M7 不动;五阶段叙事结构转由 promo 宣传加长版承载。
>
...
| 深度解析付费章节 | **命盘 / 日元 / 五行 / 格局倾向 / 事业与财富 / 婚姻感情 / 学习成长 / 身体健康(8 章,命书框架)** | 2026-08-15 晚按传统命书框架重构拆并;格局章按「模糊叙事」红线处理 |
...
**付费章节**(需 entitlement):
3. **命盘** — 四柱十神总览 + 主线三层 + 核心循环(吸收原十神结构章)
4. **日元** — 日主心性 + 旺衰 + 能量节奏
5. **五行** — 分布偏旺偏衰 + 喜忌(后端确定性) + 调候
6. **格局倾向** — 结构类型模糊叙事(禁止硬分类,产品红线)
7. **事业与财富** — 事业方向 + 求财 + 流年窗口 + 晚运趋势(吸收原财运/晚年)
8. **婚姻感情** — 婚姻 + 配偶 + 六亲缘(吸收原爱情/六亲)
9. **学习成长** — 天赋 + 高低配分界 + 充电方式(吸收原天赋/高低配/系统模式)
10. **身体健康** — 体质 + 调候 + 作息

### 每日运势

**v1 全免费,无付费触点**(2026-09-07 拍板)。原「历史回看解锁」(2026-08-30,
免费 7 天 / 任意购买解锁全部)随底部日期带整体拔除——今日 tab 定位是留存/习惯
钩子,付费转化主战场在深度解析与合盘。
...
跟深度解析同形态:
- **免费**:基础相处模式 + 互补/冲突总览
- **付费**:五行共振 / 合作事业 / 财运合拍 / 流年同步
  (第一章原「爱情深度」,2026-08-14 决策替换为「五行共振」——合盘定位升级为
  「两人磁场是否合拍」单轨叙事,详见 `docs/合盘五行共振章节决策.md`)
...
| `module=bazi_deep`,prompt=`bazi_deep_paid` | **要求 entitlement active**,返回付费 8 章(命书框架) |
...
**实现关键**:
- 现在的 `bazi_deep` prompt 拆成 `bazi_deep_free`(2 章)+ `bazi_deep_paid`(8 章命书框架,2026-08-15 晚重构)
