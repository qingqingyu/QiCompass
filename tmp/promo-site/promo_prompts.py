...
篇幅(激进 ~5x):
- bazi_deep_paid:每章 1000-1500 字,9 章(2026-08-14 加十神结构章,08-15 再加
  天赋/高低配/系统模式三章——backend v1 结构叙事的加长镜像;完整 1500-2500 字
  版仍归 v1 链独占)
...
_BAZI_V1_STRUCTURE_CHAPTERS = """**第二章：天赋能力**（1000-1500 字）
...
**第四章：人生系统模式**（1000-1500 字）
把命局当系统：输入什么 / 怎么加工 / 输出什么 / 靠什么回血（承接第一章核心循环）。
...
BAZI_DEEP_PAID_PROMO_REQUIREMENTS = """写作要求（付费 9 章 · 长文版，每章 1000-1500 字，总 9000-13500 字）：

""" + _BAZI_TEN_GOD_CHAPTER + _BAZI_V1_STRUCTURE_CHAPTERS + """**第五章：财运**（1000-1500 字）
