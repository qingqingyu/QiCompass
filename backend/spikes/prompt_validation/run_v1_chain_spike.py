...
# ---------- L1 校验与 JSON 解析(S02 起单一事实源在 evalkit,本 spike 只消费) ----------
# parse_llm_json → evalkit/llm_json.py
# _MODULE_REQUIRED_FIELDS / _V1_EXTENDED_FORBIDDEN_WORDS /
# validate_v1_module_output → evalkit/checks/deterministic.py
from evalkit.checks.deterministic import (  # noqa: E402
    _MODULE_REQUIRED_FIELDS,
    _V1_EXTENDED_FORBIDDEN_WORDS,
    validate_v1_module_output,
)
from evalkit.llm_json import parse_llm_json  # noqa: E402
