...
PROMPT_VERSIONS: dict[str, int] = {
    ...
    "bazi_deep_paid": 3,   # M2 拆分:6 章付费,Medium-deep voice(2026-08-14 加十神结构章,2→3)
...
# M2 拆分:付费 6 章(需 entitlement 才能调用)
# 章节:1. 十神结构 2. 财运 3. 爱情 4. 健康 5. 六亲 6. 晚年
...
写作要求（付费 6 章，每章 200-300 字，总 1200-1800 字）：
