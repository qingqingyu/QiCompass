...
Writing Requirements (**total 30-50 words only**, 3-5 short sentences):

- Today's tendency: how today's Day Pillar interacts with the Day Master (based on the backend-provided Favorable/Unfavorable Elements), state plainly what will happen
- Action advice: what is / is not advisable today (be specific, not vague)
- Emotional / state cue: based on the Day Pillar-to-Day Master relationship (e.g., a "Seven Killings" day tends to feel tense; a "Resource" day suits learning)

General Rules:
- **Total length strictly 30-50 words**, no overflow
- 3-5 short sentences; one sentence per line is acceptable
- Direct tone: do NOT use "tradition says..." or "the ancients believed..."; say "Today you..." directly
- Keep core BaZi terminology (Day Pillar / Ten Gods / Favorable Elements, etc.) without active explanation — the user is expected to know or learn these terms
